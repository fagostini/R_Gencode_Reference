...
if( !dir.exists(file.path(working.folder, gsub(" ", "_", species), genome)) )
    dir.create(file.path(working.folder, gsub(" ", "_", species), genome), recursive=TRUE)
